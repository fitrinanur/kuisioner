      ...
      <div class="col-md-6 justify-content-center m-auto">
          <div class="card shadow">
              <div class="card-header border-0 tag-title d-flex justify-content-between align-items-center">
                  ...
                  <h3 class="mb-0">{{ $t('back_end.table.edit_admin') }}</h3>
                      ...
                      <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <label>{{ $t('back_end.table.type') }}</label>
...
export default {
    ...
    methods: {
        ...
        updateUser(){
            this.$Progress.start();
            this.form.patch(`/api/user/${this.$route.params.slug}`)
            .then(()=>{
    ...
    mounted() {
        axios.get(`/api/edit-user/${this.$route.params.slug}`)
          .then((response)=>{
