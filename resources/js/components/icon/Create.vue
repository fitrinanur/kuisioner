        ...
        <div class="col-md-6 justify-content-center m-auto">
            <div class="card shadow">
                <div class="card-header border-0 tag-title d-flex justify-content-between align-items-center" >
                    ...
                    <h3 class="mb-0">{{ $t('back_end.table.add_new_icon') }}</h3>
                    <router-link to="/icon">
                    ...
                    <form @submit.prevent="createQuestion">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <img v-if="getProfilePhoto" :src="getProfilePhoto()" class="optionAvImg">
                                <br>
                                <br>
                            </div>
                            <div class="col-md-12">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            createQuestion(){
                this.$Progress.start();
                this.form.post(window.location.origin+'/api/icon')
                .then(()=>{

                  toast.fire({
                    type: 'success',
                    title: 'The icon has been added.'
                  })
