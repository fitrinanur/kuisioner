        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::setting') }}">
                        <i class="step__icon fa fa-themeisle" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::register') }}">
